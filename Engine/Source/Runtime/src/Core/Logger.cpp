...
namespace Galaxy
{
    ...
    void Logger::Init()
    {
        ...
        s_CoreLogger = std::make_shared<spdlog::logger>("GALAXY", begin(logSinks), end(logSinks));
        spdlog::register_logger(s_CoreLogger);
        s_CoreLogger->set_level(spdlog::level::trace);
        s_CoreLogger->flush_on(spdlog::level::trace);

        s_ClientLogger = std::make_shared<spdlog::logger>("CLIENT APP", begin(logSinks), end(logSinks));
